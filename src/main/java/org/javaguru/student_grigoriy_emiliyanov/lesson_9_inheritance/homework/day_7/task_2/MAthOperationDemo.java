...
class MAthOperationDemo {
    ...
    public static void main(String[] args) {
        ...
        Argument arg10 = new Argument(10);
        Argument arg5 = new Argument(5);
        MathOperation sub1 = new Subtraction(arg10, arg5);
        Argument arg20 = new Argument(20);
        MathOperation sub2 = new Division(arg20, arg5);
        MathOperation mult = new Multiplication(sub1, sub2);
