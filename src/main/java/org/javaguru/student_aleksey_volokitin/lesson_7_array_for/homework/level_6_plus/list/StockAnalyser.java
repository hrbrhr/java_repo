package org.javaguru.student_aleksey_volokitin.lesson_7_array_for.homework.level_6_plus.list;
...
class StockAnalyser {
    ...
    private List<Stock> stocks; // объявляем список stocks
    StockAnalyser() { this.stocks = new ArrayList<>(); } // создаем конструктор класса для списка
