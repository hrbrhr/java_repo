...
class SchoolJournalUI {
    ...
    public SchoolJournalUI(SchoolJournal schoolJournal) {
        this.schoolJournal = schoolJournal;
    }
    ...
    private void initialValues(SchoolJournal schoolJournal) {
    ...
    private void printMainJournalMenu() {
        System.out.println(" ");
    ...
    private void printListOfSubjects(List<SchoolDiary> schoolDiaries, List<String> listOfSubjects) {
    ...
    private void printListOfStudentsWithMarks(SchoolJournal schoolJournal) {
    ...
    private void findMaxMarkOfSubjectInClass(SchoolJournal schoolJournal, List<String> listOfSubjects) {
        List<SchoolDiary> schoolDiaries = schoolJournal.getSchoolDiaries();
    ...
    private void findMinMarkOfSubjectInClass(SchoolJournal schoolJournal, List<String> listOfSubjects) {
        List<SchoolDiary> schoolDiaries = schoolJournal.getSchoolDiaries();
        printListOfSubjects(schoolDiaries, listOfSubjects);
        int numberOfSubject = requestIntData("Enter number of subject: ");
        if ((numberOfSubject < 1) || (numberOfSubject > listOfSubjects.size())) {
    ...
    private void findAverageMarkOfSubjectInClass(SchoolJournal schoolJournal, List<String> listOfSubjects) {
        List<SchoolDiary> schoolDiaries = schoolJournal.getSchoolDiaries();
        printListOfSubjects(schoolDiaries, listOfSubjects);
        int numberOfSubject = requestIntData("Enter number of subject: ");
        if ((numberOfSubject < 1) || (numberOfSubject > listOfSubjects.size())) {
