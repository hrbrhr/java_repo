package org.javaguru.student_alexey_yakovlev.lesson_5.homework.level_7_senior.task_2;
...
class AverageMarkApp {
    ...
    public static void main(String[] args) {
        ...
        String[] students = getStudentsNames(scanner, studentCount);
    ...
    private static String[] getStudentsNames(Scanner scanner, int studentCount) {
